...
export const useStore = create<UIState>((set) => ({
  ...
  perfil: { empresa: "", segmento: "", cidade: "", site: "", ramo: "", telefone: "", emailContato: "", estado: "", canais: [], produtos: [], relacao: {}, logoUrl: "" },
  hydrated: false,
  zernioAccounts: [],
  selectedAccount: {},
  manualAds: [],
  ...
  setStoriesForPeriod: (rede, periodKey, n) =>
    set((s) => {
      ...
      return { manualStats: { ...s.manualStats, [rede]: { ...cur, storiesByPeriod: byP, storiesUpdatedAt: new Date().toISOString() } } };
    }),

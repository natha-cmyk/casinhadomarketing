...
export function saveConfig(s: UIState) {
  return putJSON("/api/config", {
    ...
    calManuais: s.calManuais, agentsConfig: s.agentsConfig, widgetLayout: s.widgetLayout,
  });
}

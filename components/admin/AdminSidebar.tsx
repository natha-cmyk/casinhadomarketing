...
const NAV = [
  ...
  { href: "/admin/atividade", label: "Atividade", icon: "cal" },
  { href: "/admin/financeiro", label: "Financeiro", icon: "invoice" },
  { href: "/admin/cadastros", label: "Links de cadastro", icon: "gift" },
